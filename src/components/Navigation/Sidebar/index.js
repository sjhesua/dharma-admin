    ...
    return (
      <ul className={toggled ? 'navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled' : 'navbar-nav bg-gradient-primary sidebar sidebar-dark accordion'} id="accordionSidebar">
        ...
        <a className="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
          ...
          <img src="/img/LOGO_DHARMA_GO_BLANCO.png"  style={{maxHeight:"70px",maxWidth: "100%"}} />
          </div>
        </a>
        ...
        <li className="nav-item">
          ...
          <div id="collapseTwo" className='collapse' aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div className="bg-white py-2 collapse-inner rounded">
              ...
              <Link className="collapse-item" to="/usercreate">Crear</Link>
              <Link className="collapse-item" to="/userlist">Listar</Link>
              <Link className="collapse-item" to="/cards">Eliminar</Link>
              <Link className="collapse-item" to="/cards">Bloquear</Link>
              <Link className="collapse-item" to="/cards">Editar</Link>
              <Link className="collapse-item" to="/cards">Ver</Link>
            </div>
          </div>
        </li>
